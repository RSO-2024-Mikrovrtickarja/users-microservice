...
Write-Log -Name "Initialization" -Content "Creating database microscale_users..."
Invoke-Expression "$PostgresPsqlBinary -h localhost -U postgres -c `"CREATE DATABASE microscale_users ENCODING UTF8`""
